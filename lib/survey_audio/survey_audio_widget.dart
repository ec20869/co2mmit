  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<SurveyRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<SurveyRecord> surveyAudioSurveyRecordList = snapshot.data;
        ...
        final surveyAudioSurveyRecord = surveyAudioSurveyRecordList.first;
        return Scaffold(
          key: scaffoldKey,

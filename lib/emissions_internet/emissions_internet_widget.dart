            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Expanded(
                    child: Text(
                      'An online search emits about 0.2 grams of CO2.\\n\\nA study by the Boston Consulting Group found that the internet is responsible for around 1 billion tonnes of greenhouse gas emissions per year. That’s about 2% of total emissions. In other words, the internet has an impact on the climate that’s roughly comparable to the aviation industry, which is responsible for 2% of CO2 emissions worldwide.\\n\\nThe carbon footprint of the internet comes from a few different sources. First of all, there’s the devices you use to actually access the internet. Your laptop, smartphone, TV, and any other connected device has a carbon footprint. That comes both from the manufacturing of your device, and the electricity you use to power it. Then there’s the infrastructure around the world that stores our information and keeps us connected. The many satellites, cables, and data centres that make up the internet (and the electricity used to power them) have a CO2 footprint of their own.The carbon footprint of each individual action we take online is small. But with approximately half the world’s population (4.1 billion people) being internet users, the overall effect can be pretty huge.\\n',
